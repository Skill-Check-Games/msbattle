...
export interface Standing { id: string; name: string; avatar?: string | null; country?: string | null; rank?: number; score?: number; finished?: boolean; finishMs?: number; progress?: number; rating?: number; ratingDelta?: number; provisional?: boolean; played?: number; }
