...
const CARDS: { title: string; desc: string; label: string; href: string }[] = [
	...
	{ title: "Shape playground", desc: "Minesweeper on triangles, pentagons, hexagons, heptagons, octagons, and a mixed board whose cells change shape as you cross it. Local only, for judging which geometries actually play well.", label: "Open playground", href: "/admin/shapes" },
