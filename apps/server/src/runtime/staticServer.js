...
var STATIC_ROOTS = [
	require("../paths").LEGACY_CLIENT_DIR,
	require("../paths").CORE_COMMON_DIR
];
...
var BUNDLE_PATH = path.join(require("../paths").LEGACY_CLIENT_DIR, "bundle.js");
...
var SSR_INLINE_SOURCES = [
	path.join(require("../paths").LEGACY_CLIENT_DIR, "views", "Ranking.js"),  // tierFor / overallRating
	path.join(require("../paths").LEGACY_CLIENT_DIR, "views", "Profile.js")   // paintYouCardEarly (calls the above)
];
...
var ROUTER_SOURCE = path.join(require("../paths").LEGACY_CLIENT_DIR, "ui", "Router.js");
...
var SW_SOURCE_PATH = path.join(require("../paths").LEGACY_CLIENT_DIR, "sw.js");
var SW_KILL_SWITCH = [
