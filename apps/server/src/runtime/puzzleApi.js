...
var START_PATTERNS_PATH = process.env.START_PATTERNS_PATH || path.join(require("../paths").REPO_ROOT, "deduction-patterns.json");
...
var COMBINED_PUZZLES_PATH = process.env.COMBINED_PUZZLES_PATH || path.join(require("../paths").REPO_ROOT, "combined-puzzles.json");
